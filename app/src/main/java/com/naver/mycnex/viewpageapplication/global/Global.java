...
public class Global {
    ...
    public final static String[] PETSIZE_STR_ARR = {"소형견","중형견","대형견"};
    public final static Integer[] PETSIZE_ID_ARR = {PETSIZE_SMALL,PETSIZE_MIDIUM,PETSIZE_LARGE};
    ...
    public final static String BASE_URL = "http://54.180.82.236:8080/petApplication/";
